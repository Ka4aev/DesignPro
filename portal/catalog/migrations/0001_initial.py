    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='application', validators=[catalog.models.validate_image], verbose_name='Загрузите фото заявки')),
                ('status', models.CharField(choices=[('n', 'Новая'), ('a', 'Принято в работу'), ('s', 'Выполнено')], default='n', help_text='Статус заявки', max_length=1, verbose_name='Статус заявки')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.category', verbose_name='Выберите категорию заявки')),
            ],
        ),
    ]
